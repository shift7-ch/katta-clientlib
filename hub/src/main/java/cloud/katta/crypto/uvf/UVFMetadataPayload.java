...
public class UVFMetadataPayload extends JWEPayload {
    ...
    /**
     * Creates a new instance with initialized values.
     * <p>
     * The method generates a random key identifier (KID), raw seed, and key derivation function (KDF) salt.
     * It uses these values to populate and return a configured object.
     *
     * @return a fully initialized object containing file format, name format,
     * seeds map with the generated KID and raw seed, latest seed, initial seed, the KDF algorithm, and KDF salt.
     */
