...
public class SettingsResourceApi {
    ...
    public ApiResponse<SettingsDto> apiSettingsGetWithHttpInfo() throws ApiException {
        ...
        return apiClient.invokeAPI("SettingsResourceApi.apiSettingsGet", localVarPath, "GET", localVarQueryParams, localVarPostBody,
    ...
    public ApiResponse<Void> apiSettingsPutWithHttpInfo(SettingsDto settingsDto) throws ApiException {
        ...
        return apiClient.invokeAPI("SettingsResourceApi.apiSettingsPut", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
