...
public class TrustedUserDto {
    ...
    private List<String> signatureChain = null;

    public TrustedUserDto() {
    }

    public TrustedUserDto trustedUserId(String trustedUserId) {
    ...
    public TrustedUserDto signatureChain(List<String> signatureChain) {
    ...
    @JsonProperty(JSON_PROPERTY_SIGNATURE_CHAIN)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setSignatureChain(List<String> signatureChain) {
        this.signatureChain = signatureChain;
    }
