...
public interface WoTService {
    Map<TrustedUserDto, Integer> getTrustLevels() throws ApiException, FirstLoginDeviceSetupException, AccessException, SecurityFailure;
     ...
     */
    Map<String, Integer> getTrustLevelsPerUserId() throws ApiException, FirstLoginDeviceSetupException, AccessException, SecurityFailure;
     ...
     */
    void verify(List<String> signatureChain, SignedKeys allegedSignedKey) throws FirstLoginDeviceSetupException, ApiException, AccessException, SecurityFailure;
     ...
     */
    TrustedUserDto sign(UserDto user) throws ApiException, ParseException, JOSEException, FirstLoginDeviceSetupException, AccessException, SecurityFailure;
}
