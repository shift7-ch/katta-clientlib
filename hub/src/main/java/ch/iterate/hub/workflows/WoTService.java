...
public interface WoTService {
    Map<TrustedUserDto, Integer> getTrustLevels() throws ApiException, AccessException, SecurityFailure;
     ...
     */
    Map<String, Integer> getTrustLevelsPerUserId() throws ApiException, AccessException, SecurityFailure;
     ...
     */
    void verify(List<String> signatureChain, SignedKeys allegedSignedKey) throws ApiException, AccessException, SecurityFailure;
     ...
     */
    TrustedUserDto sign(UserDto user) throws ApiException, ParseException, JOSEException, AccessException, SecurityFailure;
}
