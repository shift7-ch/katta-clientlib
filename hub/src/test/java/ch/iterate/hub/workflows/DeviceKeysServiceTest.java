...
class DeviceKeysServiceTest extends AbstractHubTest {
    @Test
    void testGetDeviceKeysFromPasswordStore() throws InvalidKeySpecException, LocalAccessDeniedException {
    ...
    @Test
    void testStoreDeviceKeysInPasswordStore() throws LocalAccessDeniedException {
        final PasswordStore storeMock = Mockito.mock(PasswordStore.class);
        final DeviceKeysService service = new DeviceKeysService(storeMock);
        final String userId = UUID.randomUUID().toString();
        final String hubId = UUID.randomUUID().toString();
    ...
    @Test
    void testStoreAndRetrieveDeviceKeys() throws InvalidKeySpecException, LocalAccessDeniedException {
        final String userId = UUID.randomUUID().toString();
        final String hubId = UUID.randomUUID().toString();
